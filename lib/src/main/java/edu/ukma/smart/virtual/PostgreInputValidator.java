...
public class PostgreInputValidator implements InputValidator {
    ...
    public PostgreInputValidator() {
        basicValidator = BasicInputValidator.BasicInputValidatorBuilder
            .builder()
            .addVendorNewTableValidator(newTable -> validateTableKeyFormat(newTable.key()))
            ...
            .addVendorAddPropertyValidator(addP -> validateTableKeyFormat(addP.tableKey()))
            .addVendorDropTableValidator(d -> validateTableKeyFormat(d.tableKey()))
            .addVendorSelectQueryValidator(sq -> validateTableKeyFormat(sq.tableKey()))
            .addVendorDeleteRowValidator(dr -> validateTableKeyFormat(dr.tableKey()))
            .addVendorDeleteRowValidator(dr -> validateRowId(dr.rowId()))
            .addVendorDropPropertyValidator(dp -> validateTableKeyFormat(dp.tableKey()))
